...
let CATEGORY_SECTION_ITEMS = [
    CategorySectionModel(name: "Romance", type: .love, color: "#DC218C"),
    ...
    CategorySectionModel(name: "Science Fiction", type: .scienceFiction, color: "#767776"),
    CategorySectionModel(name: "Psyhology", type: .psychology, color: "#513650"),
]
